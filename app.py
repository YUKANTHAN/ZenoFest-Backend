...
def _new_rows_info(rows, start_row):
    ...
    for i, row in enumerate(rows):
        ...
        info.append({
            ...
            "leader_email": field(row, "Leader Email"),
            ...
            "member_2_name": field(row, "Member 2 Name"),
            "member_2_email": field(row, "Member 2 Email"),
            "member_2_contact": field(row, "Member 2 Contact"),
            "member_3_name": field(row, "Member 3 Name"),
            "member_3_email": field(row, "Member 3 Email"),
            "member_3_contact": field(row, "Member 3 Contact"),
            "members": [
                {"name": field(row, "Member 2 Name"), "email": field(row, "Member 2 Email"), "contact": field(row, "Member 2 Contact"), "food": field(row, "Member 2 Food")},
                {"name": field(row, "Member 3 Name"), "email": field(row, "Member 3 Email"), "contact": field(row, "Member 3 Contact"), "food": field(row, "Member 3 Food")},
            ],
        })
    return info
...
def create_app(client=None):
    ...
    @app.get("/debug/raw")
    def debug_raw():
        """Dev helper: dump raw sheet headers + recent data rows so we can
        verify the true column order (esp. for member food preferences)."""
        try:
